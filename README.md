...
1. Install
    ...
    pear install https://github.com/elibom/elibom-php/raw/master/download/ElibomClient-0.0.1.tgz

    or
    
    download sources files https://github.com/elibom/elibom-php/raw/master/download/ElibomSRC.zip and decompress
